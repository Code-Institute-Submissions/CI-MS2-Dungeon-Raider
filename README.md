...
All this information was used when designing the layout, colour scheme, typography, imagery and features that were deployed to the final website and contributed to the above User Stories.
...
* ###### Combat Page
  ...
  * Enemy stats are now visible too which are clear to the user and they are now able to compare them to the player to see what strategy they may need to employ
...
* More heroes to be included (Mage, Hunter, Assassin) which would have different stats
* Audio to enhance UX and engagement
...
* A description of the player moves next to the image to make it clear what each move did
...
* "I want some element of luck to come in to the game to ensure each combat round is different"
  ...
  * The use of Math.random and Math.floor brings an element of luck in to the game as the player and enemy will each do different attack damage and number of attacks each round
...
* **[Dani Krossing](https://www.youtube.com/watch?v=M6sA8fvMCuA&list=PL0eyrZgxdwhxNGMWROnaY35NLyEjTqcgB&index=23)**
  ...
  * Code for the core elements of the game were programmed following a YouTube tutorial by Dani and adapted to own project. These changes include:
